...
impl fmt::Display for LineBotMessage{
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            LineBotMessage::Hello => write!(f, "安安"),
            LineBotMessage::PeriodOfOperationReport => write!(f, "定期營運報表"),
            LineBotMessage::SumOfOperationReport => write!(f, "累計營運報表"),
            ...
            LineBotMessage::Report => write!(f, "/report"),
        }
    }
}
